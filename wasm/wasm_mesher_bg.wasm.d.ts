...
export const unpackLightSection118: (a: number, b: number) => [number, number];
export const parseChunkDump118NoMarshal: (a: number, b: number, c: number, d: number, e: number) => number;
export const parseChunkDump118FullColumnAll: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number) => any;
